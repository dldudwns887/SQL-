...
with DAG(
    ...
    def upload_to_s3(**context):
        ...
        csv_data = context['ti'].xcom_pull(task_ids='fetch_api_data')
        s3_hook.load_string(
            string_data=csv_data,
            key='dataSource/api_raw_data.csv',
    ...
    # Task 순서 정의
    fetch_data >> upload_to_s3_task >> create_temp_table >> load_temp_redshift >> deduplicate_insert >> delete_file
